...
SENTRY_ADMIN_EMAIL = os.environ['SENTRY_ADMIN_EMAIL']
...
BROKER_URL = 'redis://{HOST}:{PORT}'.format(**REDIS)
...
SENTRY_URL_PREFIX = os.environ['MY_URL']
...
SERVER_EMAIL = 'sentry@exoscale.ch'
